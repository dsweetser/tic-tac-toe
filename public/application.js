...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameVar = __webpack_require__(14);
	...
	var getActiveGames = function getActiveGames(event) {
	  event.preventDefault();
	  if ($('.col-xs-10')) {
	    $('.col-xs-10').remove();
	  }
	  ...
	  if (store.user) {
	    api.get().then(function (response) {
	      ...
	      var g = [];
	      var total = store.games.length;
	      for (var i = 0, max = store.games.length; i < max; i++) {
	        ...
	        if (g[0] === undefined) {
	          $('#getGames').parent().parent().append('<div class="row"><div class="col-xs-10" id="temp">You Have No Open Games out of ' + total + ' games played!</div></div>');
	        } else {
	          $('#getGames').parent().parent().append('<div class="row"><div class="col-xs-10" id="temp">Your Active Games are: ' + g + ' out of ' + (total - g.length) + ' games played.</div></div>');
	        }
	      }
	    });
	    ...
	    $('#getGames').parent().parent().append('<div class="row"><div class="col-xs-10">You must be logged in to do this!</div></div>');
	  }
	};
	...
	var newGame = function newGame() {
	  ...
	  if (store.user) {
	    api.nova().then(function (response) {
	...
	var changeGame = function changeGame() {
	  event.preventDefault();
	  if ($('.col-xs-10')) {
	    $('.col-xs-10').remove();
	  }
	  ...
	  if (store.user) {
	    ...
	    api.getGame(store.gameId).then(function (response) {
	      return store.games = response.games;
	    });
	    for (var i = 0, max = store.games.length; i < max; i++) {
	    ...
	    $('#SwitchGame').parent().parent().append('<div class="col-xs-10 warning">You must be logged in to do this!</div>');
	  }
	  $('#SwitchGame')[0].reset();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpYes = function signUpYes() {
	  $('#sign-up').append('<div class="row"><div class="col-xs-10" id="temp">New User Created!</div></div>');
	  $('#sign-up')[0].reset();
	};
	...
	var signUpNo = function signUpNo() {
	  ...
	  $('#sign-up').append('<div class="row"><div class="col-xs-10 red" id="temp"><h3>Username already taken OR mismatched password</h3></div></div>');
	};

	var changePasswordYes = function changePasswordYes() {
	  $('#change-password').append('<div class="row"><div class="col-xs-10" id="temp">Password Successfully Changed!</div></div>');
	  $('#change-password')[0].reset();
	};
	...
	var changePasswordNo = function changePasswordNo() {
	  ...
	  $('#change-password').append('<div class="row"><div class="col-xs-10 red" id="temp"><h3>Bad Password, Please Retry</h3></div></div>');
	};

	var signInNo = function signInNo() {
	  $('#sign-in').append('<div class="row"><div class="col-xs-10 red" id="temp"><h3>Invalid Username or Password</h3></div></div>');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var triggerEndGame = function triggerEndGame() {
	  var board = gameVar.board;
	  var turnCounter = gameVar.turnCounter;
	...
	var turnOrder = function turnOrder(num) {
	...
	var testLogic = function testLogic(square) {
	  if (!gameVar.board) {
	    gameVar.board = ['', '', '', '', '', '', '', '', ''];
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=IM+Fell+English+SC);", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "0e57f0ee9a2a6d9cfd3a4c5b8d8b91b8.jpg";

/***/ },
/* 24 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "26efded86cf616b4425b8485fa18ef0c.png";

/***/ },
/* 25 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "8742f125f9115662333a3f0d0c2a63ae.jpg";

/***/ },
/* 26 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "b1d8a179cf002ddf7017c77921ee259c.jpg";
